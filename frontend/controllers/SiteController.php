...
class SiteController extends Controller
{
    ...
    public function actionReportcilerbdg29() 
    {
        // return $this->render('index');

        // get your HTML raw content without any layouts or scripts
        $content_value = $this->renderPartial('dks_ciler_value_bdg29');
        $content_header = $this->renderPartial('dks_ciler_header_bdg29');
        $content_footer = $this->renderPartial('dks_ciler_footer_bdg29');
